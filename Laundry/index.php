...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <?php 
          ...
          if ($_SESSION['admin']) {
            $data_user = $_SESSION['admin'];
          }else if ($_SESSION['kasir']) {
            $data_user = $_SESSION['kasir'];
          }

          $sql_user = $koneksi->query("select * from tb_user where id='$data_user'");
  ...
  <footer class="main-footer">
    ...
    <strong>Final Project</strong> PEMROGRAMAN WEB
  </footer>
