...
<body onload="window.print()">
	...
	<div style="text-align: center">Laporan Transaksi Pemasukan dan Pengeluaran</div>
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			<tr>
            	<th colspan="5" style="text-align: center;">Total Pemasukan dan Pengeluaran</th><br><br>
